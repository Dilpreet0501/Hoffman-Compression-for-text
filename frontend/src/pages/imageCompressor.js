...
const ImageCompressor = () => {
  ...
  const compressImage = async () => {
    ...
    setIsLoading(true);
       await axios.post('https://hoffman-compression-for-text-or-img-mxk6.onrender.com/img', formData).then ((res)=>{
         const {success,downloadImgUrl}= res.data;

      if (success) {
        
        setDownloadImgUrl(`https://hoffman-compression-for-text-or-img-mxk6.onrender.com${downloadImgUrl}`);
